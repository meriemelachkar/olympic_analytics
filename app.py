...
if user_menu == 'Medal Tally':
    ...
    # Obtention des listes de filtres
    years, country = helper.country_year_list(df)
    
    # Sélecteurs pour l'année et le pays
    selected_year = st.sidebar.selectbox("Select Year", years)
    selected_country = st.sidebar.selectbox("Select Country", country)
    
    # Calcul et affichage du tableau des médailles
    medal_tally = helper.fetch_medal_tally(df, selected_year, selected_country)
    
    # Titre dynamique selon les sélections
...
if user_menu == 'Overall Analysis':
    ...
    # Heatmap des événements par sport
...
if user_menu == 'Country-wise Analysis':
    ...
    # Graphique d'évolution des médailles
    country_df = helper.yearwise_medal_tally(df, selected_country)
    fig = px.line(country_df, x="Year", y="Medal")
    st.title(selected_country + " Medal Tally over the years")
    st.plotly_chart(fig)
    
    # Heatmap des performances par sport
...
if user_menu == 'Athlete wise Analysis':
    ...
    # Distribution des âges selon les médailles
    ...
    # Distribution des âges par sport (médaillés d'or)
    x = []
    name = []
    ...
    # Évolution de la participation hommes/femmes
